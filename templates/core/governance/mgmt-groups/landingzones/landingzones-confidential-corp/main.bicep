...
param landingZonesConfidentialCorpConfig alzCoreType
...
var alzPolicyAssignmentsJson = [
  loadJsonContent('../../../lib/alz/landingzones/confidential_corp/Audit-PeDnsZones.alz_policy_assignment.json')
  loadJsonContent('../../../lib/alz/landingzones/confidential_corp/Deny-HybridNetworking.alz_policy_assignment.json')
  loadJsonContent('../../../lib/alz/landingzones/confidential_corp/Deny-Public-Endpoints.alz_policy_assignment.json')
  loadJsonContent('../../../lib/alz/landingzones/confidential_corp/Deny-Public-IP-On-NIC.alz_policy_assignment.json')
  loadJsonContent('../../../lib/alz/landingzones/confidential_corp/Deploy-Private-DNS-Zones.alz_policy_assignment.json')
  // SLZ sovereign_l2_controls archetype
  loadJsonContent('../../../lib/alz/sovereign_l2/Enforce-Sov-L2-CMKM.alz_policy_assignment.json')
  loadJsonContent('../../../lib/alz/sovereign_l2/Enforce-Sov-L2-CMKP.alz_policy_assignment.json')
  loadJsonContent('../../../lib/alz/sovereign_l2/Enforce-Sov-L2-HTTPS.alz_policy_assignment.json')
  loadJsonContent('../../../lib/alz/sovereign_l2/Enforce-Sov-L2-TLS.alz_policy_assignment.json')
  // SLZ sovereign_l3_controls archetype
  loadJsonContent('../../../lib/alz/sovereign_l3/Enforce-Sov-L3-Conf.alz_policy_assignment.json')
]
...
var managementGroupFinalName = landingZonesConfidentialCorpConfig.?managementGroupName ?? 'confidential_corp'
var intRootManagementGroupFinalName = landingZonesConfidentialCorpConfig.?managementGroupIntermediateRootName ?? 'alz'
...
var unionedRbacRoleDefs = union(alzRbacRoleDefsJson, landingZonesConfidentialCorpConfig.?customerRbacRoleDefs ?? [])

var unionedPolicyDefs = union(alzPolicyDefsJson, landingZonesConfidentialCorpConfig.?customerPolicyDefs ?? [])

var unionedPolicySetDefs = union(alzPolicySetDefsJson, landingZonesConfidentialCorpConfig.?customerPolicySetDefs ?? [])

var unionedPolicyAssignments = union(
  alzPolicyAssignmentsWithOverrides,
  landingZonesConfidentialCorpConfig.?customerPolicyAssignments ?? []
)
...
module landingZonesConfidentialCorp 'br/public:avm/ptn/alz/empty:0.3.6' = {
  params: {
    createOrUpdateManagementGroup: landingZonesConfidentialCorpConfig.?createOrUpdateManagementGroup
    managementGroupName: managementGroupFinalName
    managementGroupDisplayName: landingZonesConfidentialCorpConfig.?managementGroupDisplayName ?? 'Confidential Corp'
    managementGroupDoNotEnforcePolicyAssignments: landingZonesConfidentialCorpConfig.?managementGroupDoNotEnforcePolicyAssignments
    managementGroupExcludedPolicyAssignments: landingZonesConfidentialCorpConfig.?managementGroupExcludedPolicyAssignments
    managementGroupParentId: landingZonesConfidentialCorpConfig.?managementGroupParentId ?? 'landingzones'
    managementGroupCustomRoleDefinitions: allRbacRoleDefs
    managementGroupRoleAssignments: landingZonesConfidentialCorpConfig.?customerRbacRoleAssignments
    ...
    location: parLocations[0]
    subscriptionsToPlaceInManagementGroup: landingZonesConfidentialCorpConfig.?subscriptionsToPlaceInManagementGroup
    waitForConsistencyCounterBeforeCustomPolicyDefinitions: landingZonesConfidentialCorpConfig.?waitForConsistencyCounterBeforeCustomPolicyDefinitions
    waitForConsistencyCounterBeforeCustomPolicySetDefinitions: landingZonesConfidentialCorpConfig.?waitForConsistencyCounterBeforeCustomPolicySetDefinitions
    waitForConsistencyCounterBeforeCustomRoleDefinitions: landingZonesConfidentialCorpConfig.?waitForConsistencyCounterBeforeCustomRoleDefinitions
    waitForConsistencyCounterBeforePolicyAssignments: landingZonesConfidentialCorpConfig.?waitForConsistencyCounterBeforePolicyAssignments
    waitForConsistencyCounterBeforeRoleAssignments: landingZonesConfidentialCorpConfig.?waitForConsistencyCounterBeforeRoleAssignments
    waitForConsistencyCounterBeforeSubPlacement: landingZonesConfidentialCorpConfig.?waitForConsistencyCounterBeforeSubPlacement
